...
#define DEFINE_FETCH_OPERATION(name, NAME, c_op)  \
,   MGBASE_OPERATION_FETCH_##NAME##_INT8  \
,   MGBASE_OPERATION_FETCH_##NAME##_INT16 \
,   MGBASE_OPERATION_FETCH_##NAME##_INT32 \
,   MGBASE_OPERATION_FETCH_##NAME##_INT64

MGBASE_FETCH_OP_LIST(DEFINE_FETCH_OPERATION)

#undef DEFINE_FETCH_OPERATION

,   MGBASE_OPERATION_END
}
