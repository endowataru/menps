...
public:
    ...
    ibv_direct_requester(ibv::endpoint& ep, ibv::completer& comp)
        : ep_(ep)
        , comp_(comp) { }
...
mgbase::unique_ptr<rma::requester> make_rma_direct_requester(endpoint& ep, completer& comp)
{
    return mgbase::make_unique<rma::ibv_direct_requester>(ep, comp);
}
