...
mefdn::unique_ptr<rma::requester> make_rma_requester(command_producer& cp, rpc::requester& req)
{
    return mefdn::make_unique<rma::fjmpi_requester>(cp, req);
}
