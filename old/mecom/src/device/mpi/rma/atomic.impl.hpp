    ...
    public:
        ...
        typename ServerCtx::return_type operator() (ServerCtx& sc) const
        {
            ...
            MEFDN_LOG_DEBUG(
                ...
                "src_ptr:{:x}\tresult:{}"
            ,   reinterpret_cast<mefdn::uintptr_t>(rqst.ptr)
            ,   result
            );
    ...
    public:
        ...
        typename ServerCtx::return_type operator() (ServerCtx& sc) const
        {
            ...
            MEFDN_LOG_DEBUG(
                ...
                "value:{}\tdest_ptr:{:x}"
            ,   req.value
            ,   reinterpret_cast<mefdn::uintptr_t>(req.ptr)
            );
...
private:
    ...
    public:
        ...
        typename ServerCtx::return_type operator() (ServerCtx& sc) const
        {
            ...
            // TODO
            const auto target =
                reinterpret_cast<mefdn::atomic<atomic_value_type>*>(rqst.target);
            ...
            ,   reinterpret_cast<mefdn::uintptr_t>(rqst.target)
            ,   rqst.expected
            ,   rqst.desired
            ,   expected
            );
...
public:
    ...
    ) MEFDN_OVERRIDE
    {
        ...
        ,   rqst.expected
        ,   rqst.desired
        ,   reinterpret_cast<mefdn::uintptr_t>(params.result_ptr)
        );
