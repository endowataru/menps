...
public:
    ...
    ,   const size_type     num_elems
        ...
        auto buf =
            self.template make_unique_uninitialized<element_type []>(num_elems);
    ...
    ,   const size_type     num_elems
        ...
        auto buf =
            self.template make_unique_uninitialized<T []>(num_elems);
        
        auto* buf_ptr = buf.get().get();
        
        std::copy(src_ptr, src_ptr + num_elems, buf_ptr);
        
        self.write(dest_proc, dest_rptr, buf.get(), num_elems);
