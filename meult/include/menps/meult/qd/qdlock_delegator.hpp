...
template <typename Func, typename UltItf>
struct qdlock_delegator_pool_policy {
    using element_type = qdlock_delegator_node<Func, UltItf>;
    ...
    static size_type get_pool_threshold(basic_balanced_tls_pool<qdlock_delegator_pool_policy>&) {
...
struct qdlock_delegator_policy_base
{
    ...
    using qdlock_pool_type = basic_balanced_tls_pool<qdlock_delegator_pool_policy<Func, UltItf>>;
    #else
