...
TEST(MpscBoundedBlockingQueue, Serial)
{
    const mgbase::uint64_t N = 10000;
    
    mgbase::mpsc_bounded_blocking_queue<mgbase::uint64_t, 256> buf;
...
TEST(MpscBoundedBlockingQueue, SpSc)
{
    typedef mgbase::mpsc_bounded_blocking_queue<mgbase::uint64_t, 256>  queue_type;
...
TEST(MpscBoundedBlockingQueue, MpSc)
{
    const mgbase::uint64_t N = 10000;
